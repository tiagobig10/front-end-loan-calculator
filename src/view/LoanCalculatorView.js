        ...
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Grid container spacing={2} >
                    ...
                    <Grid size={{ xs: 12, sm: 6, md: 2.5 }}>
                        <TextFieldValue required control={control} fullWidth label="Valor do empréstimo" name="loanAmount" />
                    </Grid>
                    <Grid size={{ xs: 12, sm: 6, md: 2 }}>
                        <TextField1 required type="number" control={control} fullWidth label="Taxa de juros" name="interestRate" InputProps={{
                            startAdornment: <>%</>
                        }} />
                    </Grid>
                    <Grid size={{ xs: 4 }}>
